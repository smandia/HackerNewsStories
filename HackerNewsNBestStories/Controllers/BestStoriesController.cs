...
namespace HackerNewsNBestStories.Controllers
{
    ...
    public class BestStoriesController : ControllerBase
    {
        ...
        private static List<HackerNewsStory> _cache = new List<HackerNewsStory>(); 
        ...
        {
            if (_cache == null || _cache.Count < count)
            {
            ...
            {
                var cacheResult = _cache.Take(count).OrderByDescending(x => x.score).ToArray();
                return cacheResult;
            }
